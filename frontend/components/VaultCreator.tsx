    ...
    try {
      ...
      try {
        ...
        if (error instanceof Error) {
          ...
          } else if (errorStr.includes('vault already exists')) {
            errorMessage = 'A vault with this ID already exists. Please choose a different vault ID.';
          } else if (errorStr.includes('invalid vault address')) {
            errorMessage = 'Invalid vault address. Please check your wallet connection.';
          } else {
